...
<div class="content-header">
    <div class="container-fluid">
        <div>
          <div class="col-sm-6">
            <h1><?=$languageArray['states_code'][$language]?></h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
	...
	<div class="container-fluid">
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <button type="button" class="btn btn-block btn-sm custom-add-btn" id="addState"><?=$languageArray['add_states_code'][$language]?></button>
                </div>
            </div>
          </div>
					<div class="card-body">
...
<div class="modal fade" id="addModal">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <form role="form" id="stateForm" class="custom-model-extend-form">
