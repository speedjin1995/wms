...
<div class="content-header custom-title-content-box">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="custom-title"><?=$languageArray['suppliers_code'][$language]?></h1>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div><!-- /.content-header -->
          ...
          <div class="card-header custom-card-header">
            <div class="row custom-card-header-row">
              ...
              <div class="col-11 custom-card-header-btn-col">
                <button type="button" id="multiDeactivate" class="btn btn-block custom-delete-btn custom-card-header-btn-size btn-sm"><?=$languageArray['delete_supplier_code'][$language]?></button>
                <a href="template/Supplier_Template.xlsx" download class="custom-card-header-btn-size">
                ...
                <button type="button" class="btn btn-block custom-add-btn custom-card-header-btn-size btn-sm" id="addSuppliers"><?=$languageArray['add_suppliers_code'][$language]?></button>
              </div>
            </div>
          </div>
    ...
    <div class="modal-content custom-model-content-box">
      <form role="form" id="uploadForm">
        ...
        <div class="modal-footer custom-model-fotter-box">
          ...
          <button type="button" class="btn custom-save-btn" id="uploadSupplier"><?=$languageArray['submit_code'][$language]?></button>
        </div>
      </form>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
