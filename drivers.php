...
<div class="content-header">
    <div class="container-fluid">
        <div>
			<div class="col-sm-6">
				<h1><?=$languageArray['drivers_code'][$language]?></h1>
			</div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
        ...
        <div class="row">
			<div class="col-12">
              ...
              <div class="row">
                  ...
                  <div class="col-3">
                      <button type="button" class="btn btn-block btn-sm custom-search-btn" id="addDriver"><?=$languageArray['add_driver_code'][$language]?></button>
                  </div>
              </div>
          </div>
					<div class="card-body">
...
<div class="modal fade" id="addModal">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <form role="form" id="driverForm" class="custom-model-extend-form">
            <div class="modal-header">
