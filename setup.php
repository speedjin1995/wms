...
<section class="content-header custom-title-content-box">
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-6">
				<h1 class="custom-title"><?=$languageArray['setup_code'][$language]?></h1>
			</div>
		</div>
	</div>
</section>
    ...
    <div class="card custom-main-card">
        <form role="form" id="profileForm" novalidate="novalidate">
            <div class="card-body custom-form-card-body">
                ...
                <hr class="custom-form-card-hr">
                
                <h5 class="custom-form-card-title"><?=$languageArray['indicator_detail_code'][$language]?></h5>
