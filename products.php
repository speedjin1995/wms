          ...
          <div class="card-header custom-card-header">
            <div class="row custom-card-header-row">
              ...
              <div class="col-11 custom-card-header-btn-col">
                <button type="button" id="multiDeactivate" class="btn btn-block custom-delete-btn custom-card-header-btn-size btn-sm"><?=$languageArray['delete_product_code'][$language]?></button>
    ...
    <div class="modal-content custom-model-content-box">
      <form role="form" id="uploadForm">
        <div class="modal-header custom-model-header-box">
          ...
          <button type="button" class="close custom-btn-close-icon" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>
      ...
      <form role="form" id="productForm">
        ...
        <div class="modal-body custom-model-body-box">
          ...
          <div <?php if($role != 'SADMIN'){ echo 'style="display:none;"'; } ?>>
            <div class="custom-card-box custom-card-company-box">
              <div class="card-header custom-card-box-header">
                <h6 class="custom-card-box-header-title"><i class="fas fa-building"></i><?=$languageArray['company_code'][$language]?></h6>
              </div>
          ...
          <div class="custom-card-box custom-card-product-info-box">
            <div class="card-header custom-card-box-header">
              <h6 class="custom-card-box-header-title"><i class="fas fa-info-circle"></i><?=$languageArray['product_information_code'][$language]?></h6>
            </div>
          ...
          <div class="custom-card-box custom-card-product-image-box">
            <div class="card-header custom-card-box-header">
              <h6 class="custom-card-box-header-title"><i class="fas fa-image"></i><?=$languageArray['product_image_code'][$language]?></h6>
            </div>
          ...
          <div class="custom-card-box custom-card-range-box">
            ...
            <div id="rangeWeightFields" class="card-body custom-card-box-body" style="display:none;">
              <div class="row align-items-center custom-range-set-box">
                <div class="col-md-2">
                  <label class="custom-range-set-label"><?=$languageArray['ok_weight_code'][$language]?></label>
                </div>
                
                <div class="col-md-7">
                  <input type="number" step="any" class="form-control custom-range-set-weight-1" id="okWeight" name="okWeight" placeholder="0.000">
                </div>
              ...
              <div class="row align-items-center custom-range-set-box">
                <div class="col-md-2">
                  <label class="custom-range-set-label"><?=$languageArray['lo_weight_code'][$language]?></label>
                </div>
                
                <div class="col-md-7">
                  <input type="number" step="any" class="form-control custom-range-set-weight-2" id="loWeight" name="loWeight" placeholder="0.000">
                </div>
              ...
              <div class="row align-items-center custom-range-set-box">
                <div class="col-md-2">
                  <label class="custom-range-set-label"><?=$languageArray['hi_weight_code'][$language]?></label>
                </div>
                
                <div class="col-md-7">
                  <input type="number" step="any" class="form-control custom-range-set-weight-3" id="hiWeight" name="hiWeight" placeholder="0.000">
                </div>
...
<script>
  ...
  function setRangeSet(val) {
    ...
    $('#rangeSetToggle').css('background', enabled ? '#16A34A' : 'rgba(26, 26, 26, .5)');
    $('#rangeSetKnob').css('left', enabled ? '78px' : '0px');
