...
<section class="content-header custom-title-content-box">
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-6">
				<h1 class="custom-title"><i class="fas fa-building"></i><?=$languageArray['company_profile_code'][$language]?></h1>
			</div>
		</div>
	</div>
</section>
...
<section class="content custom-table-content">
	<form role="form" id="profileForm" novalidate="novalidate">
		...
		<div class="custom-profile-box">
			<div class="card-header custom-profile-header-box">
				<h3 class="card-title custom-profile-title"><i class="fas fa-info-circle"></i><?=$languageArray['company_information_code'][$language]?></h3>
			</div>
		
			<div class="card-body custom-profile-body-box">
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="regNo"><?=$languageArray['company_reg_no_code'][$language]?> <span class="text-danger">*</span></label>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="name"><?=$languageArray['company_name_code'][$language]?> <span class="text-danger">*</span></label>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label for="chineseName"><?=$languageArray['company_chinese_name_code'][$language]?></label>
					...
					<div class="col-md-6" <?= ($includeInvoice == 'Y' ? '' : 'style="display:none;"') ?>>
						<div class="form-group">
							<label for="tinNo"><?=$languageArray['tin_no_code'][$language]?></label>
		...
		<div class="custom-profile-box">
			<div class="card-header custom-profile-header-box">
				<h3 class="card-title custom-profile-title"><i class="fas fa-map-marker-alt"></i><?=$languageArray['address_code'][$language]?></h3>
			</div>
			...
			<div class="card-body custom-profile-body-box">
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<label for="address1"><?=$languageArray['company_address_line_1_code'][$language]?> <span class="text-danger">*</span></label>
		...
		<div class="custom-profile-box">
			<div class="card-header custom-profile-header-box">
				<h3 class="card-title custom-profile-title"><i class="fas fa-phone-alt"></i><?=$languageArray['contact_details_code'][$language]?></h3>
			</div>
		...
		<!-- Banking Details -->
		<div class="custom-profile-box" <?= ($includeInvoice == 'Y' ? '' : 'style="display:none;"') ?>>
			<div class="card-header custom-profile-header-box">
				<h3 class="card-title custom-profile-title"><i class="fas fa-university"></i><?=$languageArray['banking_details_code'][$language]?></h3>
			</div>
			...
			<div class="card-body custom-profile-body-box">
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							<label for="bankerName"><?=$languageArray['banker_name_code'][$language]?></label>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="bankAccountNo"><?=$languageArray['bank_account_no_code'][$language]?></label>
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="bankSwiftCode"><?=$languageArray['bank_swift_code_code'][$language]?></label>
		...
		<div class="custom-profile-box">
			<div class="card-header custom-profile-header-box">
				<h3 class="card-title custom-profile-title"><i class="fas fa-sliders-h"></i><?=$languageArray['preferences_code'][$language]?></h3>
			</div>
			...
			<div class="card-body custom-profile-body-box">
				<div class="row">
					<div class="col-md-4" style="<?=($role != 'SADMIN') ? 'display:none' : ''?>">
						<div class="card bg-light mb-0">
							<div class="card-body p-3 d-flex align-items-center justify-content-between">
								<label><?=$languageArray['include_price_code'][$language]?></label>
					...
					<div class="col-md-4" style="<?=($role != 'SADMIN') ? 'display:none' : ''?>">
						<div class="card bg-light mb-0">
							<div class="card-body p-3 d-flex align-items-center justify-content-between">
								<label><?=$languageArray['include_photo_code'][$language]?></label>
								<div class="custom-control custom-switch">
					...
					<div class="col-md-4" style="<?=($role != 'SADMIN') ? 'display:none' : ''?>">
						<div class="card bg-light mb-0">
							<div class="card-body p-3 d-flex align-items-center justify-content-between">
								<label><?=$languageArray['include_barcode_code'][$language]?></label>
								<div class="custom-control custom-switch">
				...
				<div class="row">
					<div class="col-md-4" style="<?=($role != 'SADMIN') ? 'display:none' : ''?>">
						<div class="card bg-light mb-0">
							<div class="card-body p-3 d-flex align-items-center justify-content-between">
								<label><?=$languageArray['include_second_remark_code'][$language]?></label>
								<div class="custom-control custom-switch">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="photoUploadMode"><?=$languageArray['photo_upload_mode_code'][$language]?></label>
			...
			<div class="card-footer custom-profile-footer-box">
	...
	<form id="logoForm" enctype="multipart/form-data">
		<div class="custom-profile-box">
			<div class="card-header custom-profile-header-box">
				<h3 class="card-title custom-profile-title"><i class="fas fa-image"></i><?=$languageArray['company_logo_code'][$language]?></h3>
				<?php if(!empty($logoPath)): ?>
					<div class="custom-profile-btn">
						<button type="button" class="btn custom-preview-btn btn-sm" data-toggle="modal" data-target="#logoPreviewModal"><i class="fas fa-eye"></i> <?=$languageArray['preview_code'][$language]?></button>
					</div>
				<?php endif; ?>
			</div>
			...
			<div class="card-body custom-profile-body-box">
				<div class="row align-items-center">
					<div class="col-auto">
						<?php if(!empty($logoPath)): ?>
							<img src="<?=$logoPath?>" alt="Logo" class="img-thumbnail">
						<?php else: ?>
					...
					<div class="col">
						<div class="input-group">
							...
							<div class="input-group-append">
								<button class="btn custom-upload-logo-btn" type="submit" id="uploadLogo"><i class="fas fa-upload"></i> <?=$languageArray['upload_code'][$language]?></button>
							</div>
						</div>
						
						<span class="upload-img-notice"><?=$languageArray['recommended_file_size_code'][$language]?></span>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content custom-model-content-box">
					<div class="modal-header custom-model-header-box">
						<h5 class="modal-title custom-model-title-txt"><?=$languageArray['company_logo_code'][$language]?></h5>
						<button type="button" class="close custom-btn-close-icon" data-dismiss="modal"><span>&times;</span></button>
					</div>
					
					<div class="modal-body text-center custom-model-body-box">
