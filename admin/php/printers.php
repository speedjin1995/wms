...
if(isset($_POST['code'], $_POST['mac'], $_POST['udid'], $_POST['customer'], $_POST['users'])){
    ...
    if($_POST['id'] != null && $_POST['id'] != ''){
        if ($update_stmt = $db->prepare("UPDATE printers SET name=?, mac_address=?, udid=?, customer=?, users=? WHERE id=?")) {
        ...
        if ($insert_stmt = $db->prepare("INSERT INTO printers (name, mac_address, udid, customer, users) VALUES (?, ?, ?, ?, ?)")) {
