...
<div class="content-header custom-title-content-box">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="custom-title"><?=$languageArray['loading_orders_code'][$language]?></h1>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div><!-- /.content-header -->
  ...
  <div class="modal-dialog modal-xl" style="max-width: 90%;">
    <div class="modal-content custom-model-content-box">
      <form role="form" id="extendForm" novalidate>
        ...
        <div class="modal-body custom-model-body-box" style="max-height: 75vh; overflow-y: auto;">
          ...
          <div class="custom-card-box custom-card-product-info-box">
            <div class="card-header custom-card-box-header">
              <h5 class="custom-card-box-header-title"><?=$languageArray['weight_details_code'][$language]?></h5>
            </div>
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <span class="batch-txt-notice"><?=$languageArray['select_batches_hint_code'][$language]?></span>
                  </div>
                </div>
...
<script>
  ...
  function buildItemRow(item, idx) {
    return '<tr>' +
      ...
      '<td><input type="text" class="form-control custom-remarks-txtarea" name="items[' + idx + '][remarks]" value="' + (item.remarks || '') + '" placeholder="Remark"></td>' +
      '<td><button type="button" class="btn custom-delete-btn-icon btn-sm" onclick="removeWeightDetail(this)"><i class="fas fa-trash"></i></button></td>' +
    '</tr>';
  }
