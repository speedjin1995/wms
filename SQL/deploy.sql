...
('users_code', 'Users', '用户', 'Pengguna', 'பயனர்கள்', 'ユーザー', 10),
('add_members_code', 'Add Members', '添加成员', 'Tambah Ahli', 'உறுப்பினர்களை சேர்க்க', 'メンバー追加', 10),
('role_code', 'Role', '角色', 'Peranan', 'பங்கு', '役割', 10),
('allow_edit_code', 'Allow Edit', '允许编辑', 'Benarkan Sunting', 'திருத்த அனுமதி', '編集を許可', 10),
('allow_delete_code', 'Allow Delete', '允许删除', 'Benarkan Padam', 'நீக்க அனுமதி', '削除を許可', 10),
('created_date_code', 'Created Date', '创建日期', 'Tarikh Dicipta', 'உருவாக்கப்பட்ட தேதி', '作成日', 10),
('actions_code', 'Actions', '操作', 'Tindakan', 'செயல்கள்', '操作', 10),
('close_code', 'Close', '关闭', 'Tutup', 'மூடு', '閉じる', 10),
('submit_code', 'Submit', '提交', 'Hantar', 'சமர்ப்பி', '送信', 10),
('please_select_code', 'Please Select', '请选择', 'Sila Pilih', 'தயவுசெய்து தேர்ந்தெடுக்கவும்', '選択してください', 10),
('yes_code', 'Yes', '是', 'Ya', 'ஆம்', 'はい', 10),
('no_code', 'No', '否', 'Tidak', 'இல்லை', 'いいえ', 10),
('weighing_record_code', 'Weighing Record', '称重记录', 'Rekod Penimbangan', 'எடை பதிவு', '計量記録', 10),
('from_date_code', 'From Date', '开始日期', 'Dari Tarikh', 'தேதி முதல்', '開始日', 10),
('to_date_code', 'To Date', '结束日期', 'Hingga Tarikh', 'தேதி வரை', '終了日', 10),
('status_code', 'Status', '状态', 'Status', 'நிலை', 'ステータス', 10),
('customer_code', 'Customer', '客户', 'Pelanggan', 'வாடிக்கையாளர்', '顧客', 10),
('supplier_code', 'Supplier', '供应商', 'Pembekal', 'விநியோகஸ்தர்', '仕入先', 10),
('vehicle_no_code', 'Vehicle No', '车牌号', 'No. Kenderaan', 'வாகன எண்', '車両番号', 10),
('other_vehicle_no_code', 'Other Vehicle No', '其他车牌号', 'No. Kenderaan Lain', 'மற்ற வாகன எண்', '他の車両番号', 10),
('checked_by_code', 'Checked By', '检查人', 'Disemak Oleh', 'சரிபார்த்தவர்', '確認者', 10),
('weighed_by_code', 'Weighed By', '称重员', 'Ditimbang Oleh', 'எடைபோட்டவர்', '計量者', 10),
('product_code', 'Product', '产品', 'Produk', 'தயாரிப்பு', '製品', 10),
('search_code', 'Search', '搜索', 'Cari', 'தேடு', '検索', 10),
('add_new_code', 'Add New', '新增', 'Tambah Baharu', 'புதியதைச் சேர்', '新規追加', 10),
('serial_no_code', 'Serial No', '序列号', 'No. Siri', 'வரிசை எண்', 'シリアル番号', 10),
('do_po_no_code', 'DO / PO No', '交货单 / 采购单号', 'No. DO / PO', 'DO / PO எண்', 'DO / PO番号', 10),
('sec_bill_no_code', 'Sec Bill No', '第二账单号', 'No. Bil Kedua', 'இரண்டாம் பில் எண்', 'セカンド請求番号', 10),
('created_datetime_code', 'Created Datetime', '创建时间', 'Tarikh Masa Dicipta', 'உருவாக்கப்பட்ட தேதி நேரம்', '作成日時', 10),
('parent_code', 'Parent', '上级', 'Induk', 'முதன்மை', '親', 10),
('customer_supplier_code', 'Customer / Supplier', '客户 / 供应商', 'Pelanggan / Pembekal', 'வாடிக்கையாளர் / விநியோகஸ்தர்', '顧客 / 仕入先', 10),
('driver_code', 'Driver', '司机', 'Pemandu', 'ஓட்டுநர்', 'ドライバー', 10),
('total_item_code', 'Total Item', '总项目数', 'Jumlah Item', 'மொத்த உருப்படிகள்', '合計件数', 10),
('total_weight_code', 'Total Weight', '总重量', 'Jumlah Berat', 'மொத்த எடை', '総重量', 10),
('total_reject_code', 'Total Reject', '总拒收', 'Jumlah Tolak', 'மொத்த நிராகரிப்பு', '不合格合計', 10),
('please_enter_name_code', 'Please Enter Name', '请输入名称', 'Sila Masukkan Nama', 'தயவுசெய்து பெயரை உள்ளிடவும்', '名前を入力してください', 10),
('add_new_entry_code', 'Add New Entry', '新增记录', 'Tambah Entri Baharu', 'புதிய பதிவைச் சேர்', '新規エントリー追加', 10),
('number_short_code', 'No.', '编号', 'No.', 'எண்', '番号', 10),
('customer_other_code', 'Customer Other', '其他客户', 'Pelanggan Lain', 'மற்ற வாடிக்கையாளர்', 'その他の顧客', 10),
('others_code', 'Others', '其他', 'Lain-lain', 'மற்றவை', 'その他', 10),
('supplier_other_code', 'Supplier Other', '其他供应商', 'Pembekal Lain', 'மற்ற விநியோகஸ்தர்', 'その他の仕入先', 10),
('weight_details_code', 'Weight Details', '重量详情', 'Butiran Berat', 'எடை விவரங்கள்', '重量詳細', 10),
('add_weight_code', 'Add Weight', '添加重量', 'Tambah Berat', 'எடையைச் சேர்', '重量を追加', 10),
('grade_code', 'Grade', '等级', 'Gred', 'தரம்', '等級', 10),
('gross_code', 'Gross', '毛重', 'Kasar', 'மொத்த எடை', '総重量', 10),
('tare_code', 'Tare', '皮重', 'Tara', 'டேர் எடை', '風袋重量', 10),
('net_code', 'Net', '净重', 'Bersih', 'நிகர எடை', '正味重量', 10),
('price_code', 'Price', '价格', 'Harga', 'விலை', '価格', 10),
('total_code', 'Total', '总计', 'Jumlah', 'மொத்தம்', '合計', 10),
('time_code', 'Time', '时间', 'Masa', 'நேரம்', '時間', 10),
('reject_details_code', 'Reject Details', '拒收详情', 'Butiran Tolak', 'நிராகரிப்பு விவரங்கள்', '不合格詳細', 10),
('enter_units_code', 'Enter Units', '输入单位', 'Enter Units', 'அலகுகளை உள்ளிடுக', '単位を入力', 10),
('add_units_code', 'Add Units', '添加单位', 'Add Units', 'அலகுகளைச் சேர்க்க', '単位を追加', 10),
('customers_code', 'Customers', '客户', 'Customers', 'கஸ்டமர்கள்', '顧客', 10),
('download_template_code', 'Download Template', '下载模板', 'Download Template', 'வார்ப்புரு பதிவிறக்கம் செய்க', 'テンプレートをダウンロード', 10),
('upload_excel_code', 'Upload Excel', '上传 Excel', 'Upload Excel', 'எக்செல் பதிவேற்றுக', 'Excelをアップロード', 10),
('add_customers_code', 'Add Customers', '添加客户', 'Add Customers', 'கஸ்டமர்கள் சேர்க்க', '顧客を追加', 10),
('customer_code_code', 'Customer Code', '客户编号', 'Customer Code', 'கஸ்டமர் குறியீடு', '顧客コード', 10),
('reg_no_code', 'Reg No.', '注册号', 'Reg No.', 'பதிவு எண்', '登録番号', 10),
('parent_code', 'Parent', '上级', 'Parent', 'பெற்றோர்', '親', 10),
('customer_name_code', 'Customer Name', '客户名称', 'Customer Name', 'கஸ்டமர் பெயர்', '顧客名', 10),
('address_code', 'Address', '地址', 'Address', 'முகவரி', '住所', 10),
('phone_code', 'Phone', '电话', 'Phone', 'தொலைபேசி', '電話', 10),
('pic_code', 'PIC', '负责人', 'PIC', 'பிறந்தவர்', '担当者', 10),
('preview_data_code', 'Preview Data', '预览数据', 'Preview Data', 'தரவை முன்னோட்டம் செய்க', 'データプレビュー', 10),
('error_log_code', 'Error Log', '错误日志', 'Error Log', 'பிழை பதிவு', 'エラーログ', 10),
('company_code', 'Company', '公司', 'Company', 'நிறுவனம்', '会社', 10),
('states_code', 'States', '州/省', 'States', 'மாநிலங்கள்', '州', 10),
('enter_customer_code_code', 'Enter Customer Code', '输入客户编号', 'Enter Customer Code', 'கஸ்டமர் குறியீடு உள்ளிடுக', '顧客コードを入力', 10),
('enter_reg_no_code', 'Enter Registration No', '输入注册号', 'Enter Registration No', 'பதிவு எண் உள்ளிடுக', '登録番号を入力', 10),
('enter_customer_name_code', 'Enter Customer Name', '输入客户名称', 'Enter Customer Name', 'கஸ்டமர் பெயர் உள்ளிடுக', '顧客名を入力', 10),
('enter_address_code', 'Enter Address', '输入地址', 'Enter Address', 'முகவரி உள்ளிடுக', '住所を入力', 10),
('enter_pic_code', 'Enter your PIC', '输入负责人', 'Enter your PIC', 'உங்கள் PIC ஐ உள்ளிடுக', '担当者を入力', 10),
('suppliers_code', 'Suppliers', '供应商', 'Suppliers', 'சப்ளையர்கள்', 'サプライヤー', 10),
('add_suppliers_code', 'Add Suppliers', '添加供应商', 'Add Suppliers', 'சப்ளையர்கள் சேர்க்க', 'サプライヤーを追加', 10),
('supplier_code_code', 'Supplier Code', '供应商编号', 'Supplier Code', 'சப்ளையர் குறியீடு', 'サプライヤーコード', 10),
('supplier_name_code', 'Supplier Name', '供应商名称', 'Supplier Name', 'சப்ளையர் பெயர்', 'サプライヤー名', 10),
('enter_supplier_code_code', 'Enter Supplier Code', '输入供应商编号', 'Enter Supplier Code', 'சப்ளையர் குறியீடு உள்ளிடுக', 'サプライヤーコードを入力', 10),
('enter_supplier_name_code', 'Enter Supplier Name', '输入供应商名称', 'Enter Supplier Name', 'சப்ளையர் பெயர் உள்ளிடுக', 'サプライヤー名を入力', 10),
('add_driver_code', 'Add Driver', '添加司机', 'Add Driver', 'டிரைவர் சேர்க்க', 'ドライバーを追加', 10),
('driver_name_code', 'Driver Name', '司机姓名', 'Driver Name', 'டிரைவர் பெயர்', 'ドライバー名', 10),
('driver_ic_code', 'Driver IC', '司机身份证号', 'Driver IC', 'டிரைவர் அடையாள அட்டை', 'ドライバーIC', 10),
('enter_driver_name_code', 'Enter Driver Name', '输入司机姓名', 'Enter Driver Name', 'டிரைவர் பெயர் உள்ளிடுக', 'ドライバー名を入力', 10),
('enter_driver_ic_code', 'Enter Driver IC', '输入司机身份证号', 'Enter Driver IC', 'டிரைவர் அடையாள அட்டை உள்ளிடுக', 'ドライバーICを入力', 10),
('add_grade_code', 'Add Grade', '添加等级', 'Add Grade', 'மதிப்பீடு சேர்க்க', 'グレードを追加', 10),
('unit_code', 'Unit', '单位', 'Unit', 'அலகு', '単位', 10),
('enter_unit_code', 'Enter Unit', '输入单位', 'Enter Unit', 'அலகு உள்ளிடுக', '単位を入力', 10),
('add_vehicle_code', 'Add Vehicle', '添加车辆', 'Add Vehicle', 'வாகனத்தைச் சேர்க்க', '車両を追加', 10),
('vehicle_number_code', 'Vehicle Number', '车辆编号', 'Vehicle Number', 'வாகன எண்', '車両番号', 10),
('vehicle_weight_code', 'Vehicle Weight', '车辆重量', 'Vehicle Weight', 'வாகன எடை', '車両重量', 10),
('enter_vehicle_number_code', 'Enter Vehicle Number', '输入车辆编号', 'Enter Vehicle Number', 'வாகன எண் உள்ளிடுக', '車両番号を入力', 10),
('enter_vehicle_weight_code', 'Enter Vehicle Weight', '输入车辆重量', 'Enter Vehicle Weight', 'வாகன எடை உள்ளிடுக', '車両重量を入力', 10),
('add_products_code', 'Add Products', '添加产品', 'Add Products', 'தயாரிப்புகள் சேர்க்க', '製品を追加', 10),
('product_code_code', 'Product Code', '产品编号', 'Product Code', 'தயாரிப்பு குறியீடு', '製品コード', 10),
('product_name_code', 'Product Name', '产品名称', 'Product Name', 'தயாரிப்பு பெயர்', '製品名', 10),
('weight_code', 'Weight', '重量', 'Weight', 'எடை', '重量', 10),
('remark_code', 'Remark', '备注', 'Remark', 'குறிப்பு', '備考', 10),
('enter_product_code_code', 'Enter Product Code', '输入产品编号', 'Enter Product Code', 'தயாரிப்பு குறியீடு உள்ளிடுக', '製品コードを入力', 10),
('enter_product_name_code', 'Enter Product Name', '输入产品名称', 'Enter Product Name', 'தயாரிப்பு பெயர் உள்ளிடுக', '製品名を入力', 10),
