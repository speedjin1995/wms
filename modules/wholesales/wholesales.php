    ...
    <div class="card results-card show-dt-controls">
      <div class="card-header">
        ...
        <div class="results-header-right d-flex" style="gap: 0.5rem;">
          <div class="dropdown">
            <button class="btn btn-action custom-export-btn dropdown-toggle" type="button" id="columnToggleBtn" data-toggle="dropdown">
          ...
          <?php } ?>
          <?php if($allowAdd == 'Y'){ ?>
          <button type="button" class="btn btn-action custom-add-btn" onclick="newEntry()">
