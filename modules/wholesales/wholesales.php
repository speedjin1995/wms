      ...
      returnString += `
          ...
          <tfoot>
            <tr>
              ...
              ${allowPrice == 'Y' && userAllowPrice == 'Y' ? '<td></td><td></td><td></td><td></td><td class="text-right text-mono text-success" id="footPrice_' + row.id + '">' + totalWeightPrice.toFixed(2) + '</td>' : ''}
              <td></td>
              ${allowPhoto == 'Y' ? '<td></td>' : ''}
            </tr>
          </tfoot>
      ...
      returnString += `
          ...
          <tfoot>
            <tr>
              ...
              ${allowPrice == 'Y' && userAllowPrice == 'Y' ? '<td></td><td></td><td></td><td></td><td class="text-right text-mono text-danger">' + totalRejectPrice.toFixed(2) + '</td>' : ''}
              <td></td>
              ${allowPhoto == 'Y' && userAllowPrice == 'Y' ? '<td></td>' : ''}
            </tr>
          </tfoot>` : ''}
        </table>
      </div>
