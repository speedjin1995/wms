...
<div class="tab-pane fade" id="tabGrading">
  ...
  <!-- Summary Cards -->
  <div class="row">
    <div class="col-6 col-md-3" id="GrTotalNetCard">
  ...
  <div class="section-title dash-section-header"><?=$languageArray['net_code'][$language]?> <?=$languageArray['weight_code'][$language]?> by Product &amp; <?=$languageArray['grading_code'][$language]?></div>
  <div id="grProductBreakdown"><p class="no-data-txt"><?=$languageArray['no_data_code'][$language]?></p></div>
