...
function rejectRow(button) {
  ...
  row.find('button[onclick*="rejectRow"]').replaceWith('<button type="button" class="btn custom-edit-btn-icon btn-sm" onclick="acceptRow(this)"><i class="fas fa-check"></i></button>');
