...
if($_POST['indicator'] != null && $_POST['indicator'] != '' && $_POST['indicator'] != '-'){
  $searchQuery .= " and wholesales.indicator = '".$_POST['indicator']."'";
}
...
while($row = mysqli_fetch_assoc($empRecords)) {
  ...
  $data[] = array( 
    ...
    "modified_by"=>searchUserNameById($row['modified_by'], $db),
