                    ...
                    <div class="running-header">
                        <div class="row mb-1">
                            ...
                            <div class="col-4">
                                ...
                                <div class="header-row"><span class="header-label">'.($wholesale['status'] == 'DISPATCH' || $wholesale['status'] == 'SALE-BAL' ? 'Delivery' : 'Purchase').' No</span><span class="header-value">: '.$wholesale['po_no'].'</span></div>';
