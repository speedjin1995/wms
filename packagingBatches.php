...
<div class="content-header custom-title-content-box">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="custom-title"><?=$languageArray['batch_packaging_code'][$language]?></h1>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div><!-- /.content-header -->
        ...
        <div class="modal-body custom-model-body-box" >
          ...
          <div class="d-flex justify-content-between align-items-center custom-model-title-box">
            ...
            <div class="d-flex align-items-center custom-model-title-box-filter">
              ...
              <button type="button" class="btn custom-view-btn-sm btn-sm" id="bulkAddBtn">
  ...
  <div class="modal-dialog">
    <div class="modal-content custom-model-content-box">
      <form id="bulkAddForm" novalidate>
        <div class="modal-header custom-model-header-box">
          <h4 class="modal-title custom-model-title-txt"><?=$languageArray['bulk_add_code'][$language]?></h4>
          <button type="button" class="close custom-btn-close-icon" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div class="modal-footer custom-model-fotter-box">
          <button type="button" class="btn custom-close-btn" data-dismiss="modal"><?=$languageArray['close_code'][$language]?></button>
          <button type="submit" class="btn custom-save-btn" id="bulkAddSubmit"><?=$languageArray['add_code'][$language]?></button>
        </div>
      </div>
    </form>
  </div>
  ...
  <div class="modal-dialog" style="max-width: 60%">
    <div class="modal-content custom-model-content-box">
      <form role="form" id="shipmentForm" novalidate>
        <div class="modal-header custom-model-header-box">
          <h4 class="modal-title custom-model-title-txt"><?=$languageArray['shipment_code'][$language]?></h4>
          <button type="button" class="close custom-btn-close-icon" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div class="modal-body custom-model-body-box">
          ...
          <div class="form-group">
            <label><?=$languageArray['remark_code'][$language]?></label>
            <textarea class="form-control custom-remarks-txtarea" id="shipmentRemark" name="shipmentRemark" placeholder="<?=$languageArray['enter_remark_code'][$language]?>"></textarea>
          </div>
        </div>
      ...
      'columns': [
        ...
        { 
          ...
          render: function ( data, type, row ) {
            ...
            buttons += '<button type="button" id="print'+data+'" onclick="printBatch('+data+')" class="btn custom-print-btn-icon btn-sm"><i class="fas fa-print"></i></button>';
            
            if (row.status !== 'completed') {
              buttons += '<button type="button" id="shipment'+data+'" onclick="openShipmentModal('+data+')" class="btn custom-reject-btn-icon btn-sm"><i class="fas fa-shipping-fast"></i></button>';
            }
    ...
    for (var i = 0; i < row.weightDetails.length; i++) {
      ...
      returnString += `
        <tr>
          ...
          ${allowPhoto == 'Y' ? '<td>' + (d.photo_path ? '<a href="php/viewPhoto.php?file=' + d.photo_path + '" target="_blank" class="btn custom-view-btn-icon btn-sm"><i class="fas fa-image"></i></a>' : '') + '</td>' : ''}
        </tr>`;
    }
