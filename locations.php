...
<div class="content-header">
    <div class="container-fluid">
        <div>
            <div class="col-sm-6">
                <h1><?=$languageArray['locations_code'][$language]?></h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
                ...
                <div class="card">
                    <div class="card-header categories-card-header">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <button type="button" class="btn btn-block btn-sm custom-search-btn" id="addLocation"><?=$languageArray['add_location_code'][$language]?></button>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal-content">
      <form role="form" id="uploadForm" class="custom-model-extend-form">
          ...
          <div class="modal-footer justify-content-between">
            ...
            <button type="button" class="btn btn-success custom-save-btn" id="uploadLocation"><?=$languageArray['submit_code'][$language]?></button>
          </div>
      </form>
    </div>
    <!-- /.modal-content -->
...
<div class="modal fade" id="addModal">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <form role="form" id="locationForm" class="custom-model-extend-form">
            <div class="modal-header">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="submit" class="btn btn-primary custom-save-btn" name="submit"><?=$languageArray['submit_code'][$language]?></button>
            </div>
        </form>
      </div>
      <!-- /.modal-content -->
