...
<div class="content-header">
    <div class="container-fluid">
        <div>
			<div class="col-sm-6">
				<h1><?=$languageArray['grades_code'][$language]?></h1>
			</div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
        ...
        <div class="row">
			<div class="col-12">
              ...
              <div class="row">
                  ...
                  <div class="col-3">
                    <button type="button" class="btn btn-block btn-sm custom-search-btn" id="addGrade"><?=$languageArray['add_grade_code'][$language]?></button>
                  </div>
              </div>
          </div>
					<div class="card-body">
    ...
    <div class="modal-content">
      <form role="form" id="uploadForm" class="custom-model-extend-form">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success custom-save-btn" id="uploadGrade"><?=$languageArray['submit_code'][$language]?></button>
          </div>
      </form>
    </div>
    <!-- /.modal-content -->
...
<div class="modal fade" id="addModal">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <form role="form" id="gradeForm" class="custom-model-extend-form">
            <div class="modal-header">
  ...
  $("#gradeTable").DataTable({
    ...
    'columns': [
      ...
      { 
        ...
        render: function (data, type, row) {
          if (data == 0) {
            return '<div class="row"><div class="col-1"><button type="button" id="edit' + row.id + '" onclick="edit(' + row.id + ')" class="btn btn-success btn-sm custom-pencil-icon-btn"><i class="fas fa-pen"></i></button></div><div class="col-1"><button type="button" id="delete' + row.id + '" onclick="deactivate(' + row.id + ')" class="btn btn-danger btn-sm custom-trash-icon-btn"><i class="fas fa-trash"></i></button></div></div>';
          } 
          else{
