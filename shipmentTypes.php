...
<div class="content-header custom-title-content-box">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="custom-title"><?=$languageArray['shipment_types_code'][$language]?></h1>
      </div>
    </div>
  </div>
</div>
          ...
          <div class="card-header custom-card-header">
            <div class="row custom-card-header-row">
              ...
              <div class="col-11 custom-card-header-btn-col">
                <button type="button" id="multiDeactivate" class="btn btn-block custom-delete-btn custom-card-header-btn-size btn-sm"><?=$languageArray['delete_shipment_type_code'][$language]?></button>
                <a href="template/Shipment_Type_Template.xlsx" download class="custom-card-header-btn-size">
                ...
                <button type="button" class="btn btn-block custom-add-btn custom-card-header-btn-size btn-sm" id="addShipmentType"><?=$languageArray['add_shipment_type_code'][$language]?></button>
              </div>
            </div>
          </div>
          <div class="card-body custom-table-card-body">
						<table id="shipmentTypeTable" class="table table-bordered table-striped">
							<thead>
								<tr>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content custom-model-content-box">
      <form role="form" id="shipmentTypeForm">
        <div class="modal-header custom-model-header-box">
          <h4 class="modal-title custom-model-title-txt"><?=$languageArray['add_shipment_type_code'][$language]?></h4>
          <button type="button" class="close custom-btn-close-icon" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body custom-model-body-box">
          <div class="card-body">
            ...
            <div class="form-group">
              <label for="shipmentType"><?=$languageArray['shipment_types_code'][$language]?> *</label>
...
$(function () {
  ...
  $("#shipmentTypeTable").DataTable({
    ...
    'serverMethod': 'post',
    'ajax': {
      'url':'php/modules/shipmentTypes/loadShipmentTypes.php',
    },
    'columns': [
      {
  ...
  $.validator.setDefaults({
      submitHandler: function () {
          $('#spinnerLoading').show();
          $.post('php/modules/shipmentTypes/shipmentTypes.php', $('#shipmentTypeForm').serialize(), function(data){
  ...
  $('#uploadShipmentType').on('click', function(){
    ...
    $.ajax({
        url: 'php/modules/shipmentTypes/uploadShipmentType.php',
        type: 'POST',
  ...
  $('#multiDeactivate').on('click', function () {
    ...
    if (selectedIds.length > 0) {
      if (confirm('Are you sure you want to cancel these items?')) {
          $.post('php/modules/shipmentTypes/deleteShipmentType.php', {userID: selectedIds, type: 'MULTI'}, function(data){
              var obj = JSON.parse(data);
...
function edit(id){
  $('#spinnerLoading').show();
  $.post('php/modules/shipmentTypes/getShipmentType.php', {userID: id}, function(data){
      var obj = JSON.parse(data);
...
function deactivate(id){
  if (confirm('Are you sure you want to delete this items?')) {
    $('#spinnerLoading').show();
    $.post('php/modules/shipmentTypes/deleteShipmentType.php', {userID: id}, function(data){
        var obj = JSON.parse(data);
...
function reactivate(id){
  if (confirm('Are you sure you want to reactivate this items?')) {
    $('#spinnerLoading').show();
    $.post('php/modules/shipmentTypes/reactivateShipmentType.php', {userID: id}, function(data){
        var obj = JSON.parse(data);
