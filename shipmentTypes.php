...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark"><?=$languageArray['shipment_types_code'][$language]?></h1>
			</div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
              ...
              <div class="row">
                  ...
                  <div class="col-2">
                    <button type="button" id="multiDeactivate" class="btn btn-block bg-gradient-danger btn-sm">
                      <?=$languageArray['delete_shipment_type_code'][$language]?>
                    </button>
                  </div>                  
                  <div class="col-2">
                    <a href="template/Shipment_Type_Template.xlsx" download>
