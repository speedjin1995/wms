...
<script>
  ...
  function format (row) {
    ...
    <div class="row custom-tbl-content-box">
      <div class="col-6">
        ...
        <p class="custom-tbl-content-box-txt"><strong>Security Bill No:</strong> ${row.security_bills || ''}</p>
        <p class="custom-tbl-content-box-txt"><strong>PO No:</strong> ${row.po_no}</p>
        <p class="custom-tbl-content-box-txt"><strong>Vehicle:</strong> ${row.vehicle_no}</p>
        <p class="custom-tbl-content-box-txt"><strong>Driver:</strong> ${row.driver}</p>
      </div>
      ...
      <div class="col-6">
        ...
        <p class="custom-tbl-content-box-txt"><strong>Category:</strong> ${row.category_name || ''}</p>
        <p class="custom-tbl-content-box-txt"><strong>Location:</strong> ${row.location_name || ''}</p>
        <p class="custom-tbl-content-box-txt"><strong>Total Item:</strong> ${row.totalItems}</p>
        <p class="custom-tbl-content-box-txt"><strong>Total Weight:</strong> ${row.totalWeight ? parseFloat(row.totalWeight).toFixed(2) : '0.00'}</p>
        <p class="custom-tbl-content-box-txt"><strong>Total Reject:</strong> ${row.totalReject ? parseFloat(row.totalReject).toFixed(2) : '0.00'}</p>
        ${allowPrice == 'Y' ? '<p class="custom-tbl-content-box-txt"><strong>Total Price:</strong> RM ' + parseFloat(row.totalPrice).toFixed(2) + '</p>' : ''}
      </div>
    </div>
  ...
  function formatNormal (row) {
    ...
    ')"><i class="fas fa-print"></i></button><button type="button" class="btn custom-reject-btn-icon btn-sm" onclick="portrait('+row.id+
