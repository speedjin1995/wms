...
<div class="content-header custom-title-content-box">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <h1 class="custom-title"><?=$languageArray['packing_code'][$language]?></h1>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
</div><!-- /.content-header -->
      ...
      <div class="col-lg-12">
        <div class="card card-info">
          <div class="card-header custom-card-header">
            <div class="row">
              <div class="col-10 custom-card-header-title"></div>
...
<script>
  ...
  function formatNormal (row) {
    ...
    ')"><i class="fas fa-print"></i></button><button type="button" class="btn custom-delete-btn-icon btn-sm" onclick="portrait('+row.id+
    ')"><i class="fas fa-receipt"></i></button></div></div></div>'+
            ...
            var row = `
              <tr class="details">
                ...
                <td ${allowPhoto == 'Y' ? '' : 'style="display:none"'}>
                  ...
                  <input type="file" name="photoFiles[${idx}]" id="photoFile${idx}" accept=".png,.jpg,.jpeg" style="display:none">
                  ${detail.photoPath ? '<a href="php/viewPhoto.php?file=' + detail.photoPath + '" target="_blank" class="btn custom-view-btn-icon btn-sm mr-1" title="View Photo"><i class="fas fa-image"></i></a>' : ''}
                  <button type="button" class="btn custom-view-btn-icon btn-sm" onclick="$('#photoFile${idx}').click()"><i class="fas fa-camera"></i></button>
                  <span id="photoStatus${idx}"></span>
                </td>
                <td>
